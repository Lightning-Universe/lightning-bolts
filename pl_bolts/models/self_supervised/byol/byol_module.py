...
def cli_main():
    ...
    from pl_bolts.models.self_supervised.simclr import transforms
    ...
    if args.dataset == 'cifar10':
        ...
        dm.train_transforms = transforms.SimCLRTrainDataTransform(32)
        dm.val_transforms = transforms.SimCLREvalDataTransform(32)
        ...
        (c, h, w) = dm.size()
        dm.train_transforms = transforms.SimCLRTrainDataTransform(h)
        dm.val_transforms = transforms.SimCLREvalDataTransform(h)
        args.num_classes = dm.num_classes
