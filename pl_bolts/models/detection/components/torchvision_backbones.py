...
def _create_backbone_adaptive(model: nn.Module,
                              out_channels: Optional[int] = None) -> nn.Module:
    """
...
def _create_backbone_features(model: nn.Module,
...
def create_torchvision_backbone(model_name: str,
