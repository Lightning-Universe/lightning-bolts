...
@pytest.mark.parametrize('cli_args', ['--max_epochs 1 --limit_train_batches 3 --limit_val_batches 3 --batch_size 3'])
...
@pytest.mark.parametrize('cli_args', ['--max_epochs 1 --limit_train_batches 3 '
                                      '--limit_val_batches 3 --batch_size 3 --encoder resnet18'])
