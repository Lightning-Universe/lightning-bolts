...
@pytest.mark.parametrize('cli_args', [
    f"--data_dir {DATASETS_PATH} --max_epochs 1 --max_steps 3 --fast_dev_run --batch_size 1"
])
...
@pytest.mark.parametrize('cli_args', [
    f'--data_dir {DATASETS_PATH} --max_epochs 1 --max_steps 3 --fast_dev_run --batch_size 1 --encoder resnet18'
])
...
@pytest.mark.parametrize('cli_args', [
    f'--data_dir {DATASETS_PATH} --max_epochs 1 --max_steps 3 --fast_dev_run --batch_size 1 --online_ft'
])
...
@pytest.mark.parametrize(
    'cli_args', [
        f'--dataset cifar10 --data_dir {DATASETS_PATH} --max_epochs 1 --max_steps 3 --fast_dev_run --batch_size 1'
