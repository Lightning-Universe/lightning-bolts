...
@pytest.mark.parametrize('cli_args', [f"--data_dir {data_dir} --max_epochs 1 --max_steps 3 --fast_dev_run --batch_size 2"])
...
@pytest.mark.parametrize('cli_args', [f'--data_dir {data_dir} --max_epochs 1 --max_steps 3 --fast_dev_run --batch_size 2 --encoder resnet18'])
...
@pytest.mark.parametrize('cli_args', [f'--data_dir {data_dir} --max_epochs 1 --max_steps 3 --fast_dev_run --batch_size 2 --online_ft'])
...
@pytest.mark.parametrize(
    'cli_args', [
        f'--dataset cifar10 --data_path {data_dir} --max_epochs 1 --max_steps 3 --fast_dev_run --batch_size 2 --gpus 0 --arch resnet18'
        ' --hidden_mlp 512 --fp32 --sinkhorn_iterations 1 --nmb_prototypes 2'
    ]
)
