...
_DEFAULT_ARGS = f" --data_dir {DATASETS_PATH} --max_epochs=1 --max_steps=2 --batch_size=4 --num_workers=0 "
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(  # fixme
            ...
            _DEFAULT_ARGS + _ARG_GPUS + " --dataset=cifar10 --hidden_mlp=512 --encoder=resnet18",
            marks=[
                pytest.mark.skipif(**_MARK_REQUIRE_GPU),
                pytest.mark.xfail(reason="failing for GPU as some is on CPU other on GPU"),
            ],
        ...
        pytest.param(  # fixme
            "models.self_supervised.cpc.cpc_module",
            _DEFAULT_ARGS + _ARG_GPUS + " --datase=stl10 --hidden_mlp=512 --encoder=resnet18",
            marks=[
                pytest.mark.skipif(**_MARK_REQUIRE_GPU),
                pytest.mark.xfail(reason="failing for GPU as some is on CPU other on GPU"),
            ],
        ...
        pytest.param(
            ...
            _DEFAULT_ARGS + _ARG_GPUS + " --online_ft --fp32",
            marks=pytest.mark.skipif(**_MARK_REQUIRE_GPU),
        ),
        pytest.param(
        ...
        pytest.param(
            ...
            _DEFAULT_ARGS + _ARG_GPUS + " --dataset=cifar10 --arch=resnet18 --hidden_mlp=512 --fp32"
