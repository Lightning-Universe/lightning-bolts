...
import pytest
import torch
from pl_bolts.utils import _IS_WINDOWS, _JSONARGPARSE_GREATER_THAN_4_16_0, _GYM_GREATER_EQUAL_0_20
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("models.rl.sac_model", "--env=Pendulum-v0 --max_steps=10 --fast_dev_run=1 --batch_size=10", marks=pytest.mark.skipif(_GYM_GREATER_EQUAL_0_20, reason="gym.error.DeprecatedEnv: Env Pendulum-v0 not found")),
        pytest.param(  # fixme
